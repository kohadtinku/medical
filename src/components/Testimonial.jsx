  ...
  return (
    <div class="mt-4 font-[sans-serif] max-w-6xl max-md:max-w-lg  py-10 mb-20 mx-10 px-10">
      ...
      <div class="grid md:grid-cols-3 gap-6 max-md:justify-center mt-12">
        <div class="border border-gray-300 lg:p-6 p-4 rounded-xl bg-white relative"  data-aos="fade-right">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-xs text-[#ff0000] font-semibold mt-1">
                CEO, Company
              </p>
            </div>
          </div>
        ...
        <div class="border border-gray-300 lg:p-6 p-4 rounded-xl bg-white relative" data-aos="fade-up">
          <div class="flex items-center">
            <img
        ...
        <div class="border border-gray-300 lg:p-6 p-4 rounded-xl bg-white relative" data-aos="fade-down">
          <div class="flex items-center">
            <img
