  ...
  return (
    <footer class="bg-[#f2eded] py-12 px-10 font-sans tracking-wide">
      <div class="lg:max-w-[50%] mx-auto text-center">
        <h3 class="text-3xl font-bold text-gray-800" data-aos="zoom-in">
          Newsletter
        </h3>
        <p class="text-sm mt-6 text-gray-500" data-aos="fade-right">
        ...
        <div
          class="bg-[#dddddd] flex px-2 py-1.5 rounded-full text-left mt-10"
          data-aos="fade-down"
        >
          <input
            type="email"
      ...
      {/* <div class="flex max-lg:flex-col items-center justify-between gap-6">
        <ul class="flex flex-wrap justify-center gap-x-6 gap-4 mt-10">
          <li>
