      ...
      <div className="services mt-28">
        <div className="section">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 max-md:max-w-lg mx-auto">
                    ...
                    <div class="p-6 absolute bottom-0 left-0 right-0 z-20">
                      ...
                      <div class="mt-4">
                        <p class="text-gray-200 text-sm">
                          Explore the dynamics of the global medicine market and
                          learn how to effectively navigate the complexities of
                  ...
                  <div class="bg-white cursor-pointer rounded overflow-hidden group relative before:absolute before:inset-0 before:z-10 before:bg-black before:opacity-50">
                    ...
                    <div class="p-6 absolute bottom-0 left-0 right-0 z-20">
                      ...
                      <div class="mt-4">
                        <p class="text-gray-200 text-sm">
                          Gain insights on maintaining compliance with
                          international regulations and standards in the
                  ...
                  <div class="bg-white cursor-pointer rounded overflow-hidden group relative before:absolute before:inset-0 before:z-10 before:bg-black before:opacity-50">
                    ...
                    <div class="p-6 absolute bottom-0 left-0 right-0 z-20">
                      ...
                      <div class="mt-4">
                        <p class="text-gray-200 text-sm">
                          Stay ahead by understanding the upcoming trends and
                          future predictions in the import-export medicine
                          sector.
                        </p>
                      </div>
                    </div>
          ...
          <div className="content ">
            <div class="font-[sans-serif] c_service py-10">
              <div class="max-w-7xl mx-auto">
