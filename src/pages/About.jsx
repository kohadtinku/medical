        ...
        <div class="relative overflow-hidden">
          <div class="max-w-screen-xl mx-auto py-16 px-4 sm:px-6 lg:py-32 lg:px-8">
            <div class="relative z-10 text-center lg:text-left">
              <h1 class="text-4xl tracking-tight leading-10 font-extrabold text-white sm:text-5xl sm:leading-none md:text-6xl lg:text-7xl" data-aos='zoom-in'>
                Welcome to
                <br class="xl:hidden" />
              ...
              <div class="mt-12 sm:flex sm:justify-center lg:justify-start" data-aos='zoom-in'>
          ...
          <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2" data-aos='zoom-in'>
            <img
